...
class Ui_controlSettings(object):
    def setupUi(self, controlSettings):
        ...
        self.horizontalLayout_2.addWidget(self.l_PIDInterval)
        ...
        self.horizontalLayout_2.addWidget(self.b_arm)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.l_yaw.sizePolicy().hasHeightForWidth())
        self.l_yaw.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.l_vertical.sizePolicy().hasHeightForWidth())
        self.l_vertical.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.l_throttle.sizePolicy().hasHeightForWidth())
        self.l_throttle.setSizePolicy(sizePolicy)
